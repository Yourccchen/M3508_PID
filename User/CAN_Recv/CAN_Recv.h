...
extern void RM_CAN1_FIRST(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
extern void RM_CAN2_FIRST(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
